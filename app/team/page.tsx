    ...
    <main className="min-h-screen bg-black text-white">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              <h1 className="text-5xl md:text-7xl font-headliner gradient-heading leading-tight">
                MEET<br/>
                <span className="text-[#ff0000]">TRISTAN</span>
              </h1>
              
              <div className="w-20 h-1 bg-[#ff0000]"></div>
              
              <p className="text-xl md:text-2xl text-gray-300">
                Owner &amp; Master Barber
              </p>
              <p className="text-lg md:text-xl text-[#ff0000] font-headliner tracking-wide italic">
      ...
      <section className="py-20 md:py-32 px-4 md:px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="w-20 h-1 bg-[#ff0000] mx-auto mb-16"></div>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">

            {/* Nick */}
            <div className="border border-zinc-800 bg-zinc-950 p-8 text-center group hover:border-[#ff0000]/30 transition-colors">
              <div className="w-32 h-32 mx-auto mb-6 rounded-full bg-zinc-900 flex items-center justify-center overflow-hidden">
                <span className="text-5xl font-headliner text-zinc-700">N</span>
              </div>
              <h3 className="text-2xl font-headliner text-white mb-1">NICK</h3>
              <p className="text-[#ff0000] text-sm font-semibold tracking-wider mb-4">SENIOR BARBER</p>
              ...
              <a
                href="https://www.instagram.com/barberniks"
                target="_blank"
            ...
            <div className="border border-zinc-800 bg-zinc-950 p-8 text-center group hover:border-[#ff0000]/30 transition-colors">
              ...
              <a
                href="https://www.instagram.com/kevinmarkarana"
                target="_blank"
                rel="noopener noreferrer"
                className="text-[#ff0000] hover:underline text-sm"
              >
            ...
            <div className="border border-zinc-800 bg-zinc-950 p-8 text-center group hover:border-[#ff0000]/30 transition-colors">
              ...
              <a
                href="https://www.instagram.com/dhelatyourservice"
                target="_blank"
                rel="noopener noreferrer"
                className="text-[#ff0000] hover:underline text-sm"
              >
            ...
            <div className="border border-zinc-800 bg-zinc-950 p-8 text-center group hover:border-[#ff0000]/30 transition-colors">
              ...
              <a
                href="https://www.instagram.com/barber.leka"
                target="_blank"
                rel="noopener noreferrer"
                className="text-[#ff0000] hover:underline text-sm"
              >
