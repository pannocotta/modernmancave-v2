          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {products.map((product) => {
              ...
              return (
                <div
                  key={product.id}
                  className="bg-zinc-900 rounded-lg overflow-hidden hover:shadow-xl hover:shadow-[#ff0000]/20 transition-all duration-300"
                >
                          ...
                          {product.images.map((_, idx) => (
                            <button
                              ...
                              className={`w-2 h-2 rounded-full transition-all ${
                                idx === currentImageIndex ? 'bg-[#ff0000] w-4' : 'bg-white/50'
                              }`}
      ...
      <section className="py-12 bg-zinc-900">
        <div className="max-w-4xl mx-auto px-4 md:px-6 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-6 text-gray-400">
            <div>
              <svg className="w-8 h-8 mx-auto mb-2 text-[#ff0000]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
